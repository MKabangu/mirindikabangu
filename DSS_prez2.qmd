...
format: 
  revealjs:
    ...
    footer: |
      [Back to Site](https://mkabangu.github.io/mirindikabangu/2024-surgery-research-day)
css: custom.css
filters: 
  - naquiz
---
...
## Initial Presentation {transition="slide"}
...
## Seeking Further Medical Attention {transition="slide"}
...
## Diagnostic Imaging {transition="slide"}
...
## Management Plan {transition="slide"}
...
## Persistent Symptoms {transition="slide"}
...
## Counseling on Treatment Options {transition="slide"}
...
## Decision and Procedure {transition="slide"}
...
## Follow-Up and Outcome {transition="slide"}
...
## Challenge Questions {transition="slide"}
...
#### Differential Diagnosis of IIH {transition="slide"}
...
#### Improvement in Visual Disturbances {transition="slide"}
...
#### Reduction in Acetazolamide Dosage {transition="slide"}
...
#### Impact of Comorbid Conditions {transition="slide"}
